                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="col-lg-6 col-sm-6">
                                <input type="radio" class="img-cb" id="check1" name="postcard_id" value="1" />
                                <img src="<?php echo Url('/public/images/postcards/p1_thumb.png') ?>" class="img-responsive" />
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <input type="radio" class="img-cb" id="check2" name="postcard_id" value="2" />
                                <img src="<?php echo Url('/public/images/postcards/p2_thumb.png') ?>" class="img-responsive" />
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <input type="radio" class="img-cb" id="check2" name="postcard_id" value="3" />
                                <img src="<?php echo Url('/public/images/postcards/p3_thumb.png') ?>" class="img-responsive" />
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <input type="radio" class="img-cb" id="check2" name="postcard_id" value="4" />
